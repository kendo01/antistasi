...
waitUntil {sleep 1; (dateToNumber date > _endTime) or ({_x distance _posTarget < 150} count _soldiers > 5) or (3*({(alive _x) and !(captive _x)} count _soldiers) < _numSoldiers)};
