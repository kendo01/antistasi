if (player != Dolvich) exitWith {hint localize "STR_INFO_MOVEASSETS_1"};
...
_object addAction [localize "STR_ACT_MOVEASSET", {_actionParams spawn AS_fnc_moveObject},nil,0,false,true,"","(_this == Dolvich)", 5];
